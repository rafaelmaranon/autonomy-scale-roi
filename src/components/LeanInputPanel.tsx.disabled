...
export function LeanInputPanel({ inputs, onInputChange }: LeanInputPanelProps) {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6 h-fit sticky top-6">
      <h3 className="text-lg font-semibold text-gray-900 mb-6">Model Inputs</h3>
